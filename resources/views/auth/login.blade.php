                ...
                <div class="welcome-area">
                    ...
                    <div class="join-area">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0);" class="text-light text-center d-block">Belum memiliki akun
                                ?</a>
                            <a href="{{ route('register') }}" class="btn-link d-block ms-3 text-underline">Daftar</a>
                        </div>
                    </div>
                </div>
            </div>
