            ...
            <div class="container vh-100">
                <div class="welcome-area">
                    <div class="bg-image bg-image-overlay"
                        style="background-image: url(template/assets/images/login/pic4.jpg);"></div>
                    <div class="join-area">
                        <div class="started">
                            <h1 class="title">Buat Akun Baru</h1>
                            <p>Masukkan data Anda untuk mendaftar di portal PK4L.</p>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0);" class="text-light text-center d-block">Sudah memiliki akun
                                ?</a>
                            <a href="{{ route('login') }}" class="btn-link d-block ms-3 text-underline">Masuk</a>
                        </div>
                    </div>
                </div>
            </div>
